...
const Header = () => {
  ...
  <header className="text-center p-2 left-0 top-0 bg-gradient-to-b from-yellow-200 to-yellow-300">
    ...
    <div class="left-[902px] top-[60px] absolute text-green-950 text-lg font-normal font-['Inter']">
    <Link href="/senior/senior_home">
      管理画面
    </Link>
    </div>
    <div class="left-[992px] top-[60px] absolute text-green-950 text-lg font-normal font-['Inter']">
